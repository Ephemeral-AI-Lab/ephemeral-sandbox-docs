> **Recovered file — verbatim import.** Source: `docs/obsidian/ephemeral-os/implementation_plan/finalize-policy/spec.md` at `0f7d02486^` (deleted by `0f7d02486` 2026-07-11, "chore: remove obsolete docs and polish fleet cards"). THE §2.x spec: every §2.3/§2.4/§2.5/§2.6/§2.7 and F-rule citation in the workspace_session/command code resolves into this document.

...
Status: **STAGE 04 POC IMPLEMENTATION AND DIRECT VERIFICATION PASS**

Stage 04 product code, product tests, all 128 typed E2E cases, the focused
benchmark, and the dependency/portable-core audit have direct retained `PASS`
evidence. The selected Linux/arm64 environment cell passed; six unexecuted
qualification cells remain visibly `NOT_RUN`. The focused benchmark is Stage 04
POC evidence only. Release-wide qualification, generalized platform/image claims,
authority cutover, and v1 retirement remain `DEFERRED_STAGE_07`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `S04-V01` | Typed catalog complete/stable | catalog + `S04-E01`–`E12` collection | `CMD-E01`, `CMD-E02` | stable IDs, case count, catalog digest | every mandatory case collected once | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | no runtime resources |
| `S04-V02` | Frozen v2/v3 bytes/IDs/bounds/RootId | core golden/hostile/host independence | `CMD-G02` | test logs, corpus/source digests | exact PASS, zero fixture drift | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | no runtime resources |
| `S04-V03` | `legacy_v1` sole public authority | product route observation + `E04-07` | `CMD-P05`, `CMD-E03` | read/write authority, fallback counters | both `legacy_v1`; fallback 0 | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | exact E2E ledger |
| `S04-V04` | Stage 03 compatibility retained | inherited publication/security suites | `CMD-P05` | direct new logs; Stage 03 hashes labeled inherited | all selected regressions PASS | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | test process exit |
| `S04-V05` | Exact empty/deep/wide/tiny reconstruction | product + `E01-01`–`04` | `CMD-P03`, `CMD-E03` | typed IDs, lengths, entries, root, allocations | exact fixture; `D=64`; bounded | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | `L01`–`L13` |
| `S04-V06` | Large/sparse/raw-byte reconstruction | product + `E01-05`–`07` | `CMD-P03`, `CMD-E03` | content, extents, raw names, root, buffer | exact; buffer ≤256 KiB | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | exact build cleanup |
| `S04-V07` | xattr/hardlink/symlink | product + `E01-08`–`10` | `CMD-P03`, `CMD-E03` | xattrs, inode/link graph, targets, no-follow | exact or typed pre-mutation unsupported | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | exact build cleanup |
| `S04-V08` | metadata/device/FIFO | product + `E01-11`–`12` | `CMD-P03`, `CMD-E03` | metadata/capabilities/root | exact supported; typed unsupported | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | no mutation on failure |
| `S04-V09` | deleted/opaque/renamed/mixed | product + `E01-13`–`17` | `CMD-P03`, `CMD-E03` | final path set, whiteout/opaque/link metadata/root | exact fixture | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | exact build cleanup |
| `S04-V10` | Typed/capability/hostile failure before mutation | `S04-E02` | `CMD-P03`, `CMD-E03` | pre/post tree/resources, error type | no new lease/mount/upper/current/fallback | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | baseline restored |
| `S04-V11` | Valid generation reuse | `E03-01`, benchmark 0–12s | `CMD-E03`, `CMD-B02` | generation/fence, build/hydration counter delta | same valid generation; build work 0 | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | session/build cleanup |
| `S04-V12` | Same-key single-flight, orphan/last-locator recovery, crash residue | `E03-02`–`07` | `CMD-P03`, `CMD-E03` | owner/waiters, result IDs, selected/last-locator state, source holds, residue bytes | one build; bounded attributable residue; orphan exact; current/last fails closed | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | waiters/tasks/permits 0; exact residue classified |
| `S04-V13` | Manifest after fully synced verified carrier | `E05-03`–`13`, `L02`–`L03` | `CMD-P03`, `CMD-E03` | sync events, manifest/carrier/root/capabilities | no manifest before verified durability | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | private residue owned |
| `S04-V14` | Atomic `CURRENT` and exact fence | `E05-13`–`19`, `L04` | `CMD-P03`, `CMD-E03` | temp/fsync/rename/parent events, selector bytes | old or complete, never partial | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | recovery terminal |
| `S04-V15` | Exact generation lease before mount | `E06-01`–`05`, `E07-01`, `L05` | `CMD-P04`, `CMD-E03` | ordered lease/mount events and tuple | exact tuple, lease durable first | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | unmount then release |
| `S04-V16` | Stable old session over head/current change | `E07-02`–`03`, `L06` | `CMD-P04`, `CMD-E03` | old/new session root/generation/fence | old stable; later admission new | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | both exact leases released |
| `S04-V17` | Shared carrier, isolated writable/execution state | `E07-04`–`05` | `CMD-P04`, `CMD-E03` | inode/carrier and distinct dirs/ns IDs | only carrier shared | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | each session exact teardown |
| `S04-V18` | Grace/final recheck deletion | `E07-06`–`07`, `L09`–`L10` | `CMD-P03`, `CMD-E03` | lease/pin/current/last-locator timeline and recheck | no protected deletion; reacquire or last-locator status blocks | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | eligible only after final check |
| `S04-V19` | Build/state failpoints | `E05-01`–`08` | `CMD-P03`, `CMD-E03` | each failpoint/restart/tree/state | old/absent selection; typed recovery | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | residue bounded/reaped |
| `S04-V20` | Manifest sync failpoints | `E05-09`–`13` | `CMD-P03`, `CMD-E03` | write/fsync/rename/dir-sync boundaries | no premature selection | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | exact operation recovery |
| `S04-V21` | `CURRENT`/terminal/response failpoints | `E05-14`–`19` | `CMD-P03`, `CMD-E03` | selector/terminal/retry IDs | old or complete; retry no rebuild | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | exact operation terminal |
| `S04-V22` | Admission/mount response failpoints | `E06-01`–`07` | `CMD-P04`, `CMD-E03` | state/lease/session/mount/response IDs | no duplicate or partial session | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | reverse rollback |
| `S04-V23` | Unmount/lease-release failpoints | `E06-08`–`10` | `CMD-P04`, `CMD-E03` | mountinfo, lease state, retry | lease retained until unmount; exact once | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | mount+lease absent |
| `S04-V24` | Cancel/panic/timeout/shutdown/restart | `S04-E08` | `CMD-P03`, `CMD-P04`, `CMD-E03` | ownership graph, joins, resources | terminal typed result; no leak | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | `R01`–`R08` |
| `S04-V25` | Strict command/file/PTY/workspace native route | `S04-E04` | `CMD-P04`, `CMD-E03` | route identity, selected tuple, operation results | exact native route; no fallback | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | session exact teardown |
| `S04-V26` | `/eos` masked and mount native/no fallback | `E04`, `E11`, overlay tests | `CMD-P04`, `CMD-E03` | workload probes, mountinfo, kernel errors | `/eos` invisible; no mount fallback | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | namespace unmounted |
| `S04-V27` | Warm forbidden work zero | every warm `E04` sample | `CMD-E03`, `CMD-B02` | before/after deltas for CDC/object/hash/locator/compaction/pack/GC/squash/materialization/fallback | each delta exactly 0 | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | counters settle |
| `S04-V28` | Restart/concurrency routing and isolation | `E04-05`–`06`, `E07` | `CMD-P04`, `CMD-E03` | session/generation/ns/results | stable exact results; bounded | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | all owned resources 0 |
| `S04-V29` | Quotas/backpressure/resources | `S04-E09` | `CMD-P03`, `CMD-E03` | workers/buffer/permits/RSS/FD/maps/queues | ≤4; ≤256 KiB; RSS caps; bounded | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | all final gauges 0 |
| `S04-V30` | MCTS inactive/active allocation | `S04-E10` | `CMD-E03`, `CMD-B02` | refs/materializations/uppers/leases deltas | inactive O(1) refs; active private state | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | active fork teardown |
| `S04-V31` | Linux/backend capability correctness | `S04-E12` supported cells | `CMD-E03` | kernel/backend/fs/capability identities | per-cell direct result only | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | exact cell resources |
| `S04-V32` | Docker/arch/target matrix | `S04-E12` | `CMD-E03` per selected env | image/platform/arch/target result | unrun `NOT_RUN`; no universal claim | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `stage07-deferral-audit.json` SHA-256 `7f4173df64a8e37e427efcd26e2158707505af18a9eeac6c810d9e61b4fb0e6c` | per-cell cleanup |
| `S04-V33` | Dependency/portable-core boundary | Cargo metadata + source audit | `CMD-D01`, `CMD-P02` | dependency graph/delta, unsafe/OS import audit | zero unexplained delta; core portable | `PASS` | `dependency/dependency-delta-final.json` SHA-256 `a4fd0ed027f72bad8ae717d6fbf320122688d9fdb600ae385432dc88cf2b993b`; `dependency/boundary-audit.json` SHA-256 `dd8ce7c5c44daa22bbac6924377d72b24b4dfa3df969a6086adf261384091baf` | no runtime resources |
| `S04-V34` | Plan/schema/golden/runner dispatch | benchmark contract tests | `CMD-A01`, `CMD-B01` | expanded plan, schema/golden digests | exact frozen 180/150/60 contract | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | no live topology |
| `S04-V35` | Verifier negative cases | artifact compatibility tests | `CMD-A01` | one rejection artifact per §12.2 | every malformed claim rejected | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | temp test artifacts removed |
| `S04-V36` | One runner-owned monotonic clock | focused campaign | `CMD-B02` | start/stop/deadline/last admission/ledger sync | admission <150s; complete ≤180s | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | ledger durable inside clock |
| `S04-V37` | Counterbalanced raw timing and sufficiency | focused campaign | `CMD-B02` | order, matched pairs, raw samples/counts | p95 only with ≥20/arm/cell | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | topology teardown |
| `S04-V38` | Cold throughput/activation gates | 12–47s campaign | `CMD-B02` | `R`, `E`, copy controls, raw timings | ≥70%; p95 ≤1.5×copy+warm | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | build/session cleanup |
| `S04-V39` | Warm depth/mount/command/file/PTY gates | 47–77s campaign | `CMD-B02` | per-depth samples through `D=64`, counters | Prep 04 gates in §11.4 | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | sessions/executions 0 |
| `S04-V40` | Concurrent build/session/switch/MCTS | 77–137s campaign | `CMD-B02` | waiter/session/current/lease/MCTS samples | exact/isolation/bounded, matched | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | owners/resources 0 |
| `S04-V41` | Representative restart recovery | 137–150s campaign | `CMD-B02` | deterministic failpoint/restart outcome | old or complete; no leak | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | recovered exact run |
| `S04-V42` | Allocated-space equation and residue | all ten samples | `CMD-B02` | buckets, sharing evidence, `T` residual | cold staging ≤5%; unexplained final 0 | `PASS` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | final allocation reconciled |
| `S04-V43` | Append-only before/after reporting | report review around every command | exact command being reported | report file digest and entries | complete pair, no history edit | `PASS` | `e2e/test-report.md`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | exact cleanup recorded |
| `S04-V44` | Benchmark note evidence honesty | doc review after verifier | `CMD-H01` | links/digests/statuses | missing cells not promoted | `PASS` | `commands/CMD-H01-FINAL-D214.json` SHA-256 `45b1110a1ccbfa7b75201e4efa64e9aba3e36d52d7f0b88416e5ef44e75aa7b8`; `docs-final-validation.json` SHA-256 `1da3cc7aa960073550947acfe020904b4bcf40d30d1988ac89c712cf13bb420c` | references ledger |
| `S04-V45` | Complete `/eos` lifecycle/ownership | `S04-E11`, `L01`–`L13` | `CMD-E03` | inventories/mountinfo/allocated bytes/sentinels | all lifecycle assertions exact | `PASS` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | `L11`–`L13` |
| `S04-V46` | Final v1 authority regression | product + public E2E comparison | `CMD-P05`, `CMD-E03` | route/bytes/results/counters | v1 behavior exact; authority v1 | `PASS` | `final-v1-authority.json` SHA-256 `22eac843a5f44b6aeb8d5054089d7d2d16928c69eb0c78f1d13761158cac0073`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | no candidate leak |
| `S04-V47` | Outgoing Stage 04.5 and Stage 05 handoffs complete | doc/evidence review | `CMD-H01` | source/run/artifact hashes, blockers/deferrals | no unsupported claim; exact custody | `PASS` | `handoff_from_stage_04.md`, `handoff_to_stage_05.md`, and `benchmark_note.md`; `commands/CMD-H01-FINAL-D214.json` SHA-256 `45b1110a1ccbfa7b75201e4efa64e9aba3e36d52d7f0b88416e5ef44e75aa7b8` | cleanup digest included |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `S04-G01` | — | fresh custody/ownership inventory | `PASS` | `S04-V43`; exact pre-entry retained |`custody-pre.json`; `identities.json`; `commands/CMD-G02.json` SHA-256 `b73cdcc4c23c4c98ae58379960a91a7a4de09f2a308f3e00526ddd6e478ebc98`| implementation owner; shared custody | exact cleanup/custody PASS | 2026-07-26 |
| `S04-G02` | `G01` | handoff/decision/corpus/evidence identity reconciliation | `PASS` | all recorded digests agree; contradiction handled per §1.3 |`custody-pre.json`; `identities.json`; `commands/CMD-G02.json` SHA-256 `b73cdcc4c23c4c98ae58379960a91a7a4de09f2a308f3e00526ddd6e478ebc98`| implementation owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-G03` | `G02` | authority baseline | `PASS` | `S04-V03` direct result | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | product owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-G04` | `G02` | frozen contract baseline | `PASS` | `S04-V02` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | core owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-G05` | `G02` | approved `/eos` owner map | `PASS` | `S04-V45`; no ambiguous/forbidden path | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | storage owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-G06` | `G01`–`G05` | locked environment and artifact root | `PASS` | identities/capabilities/ports/root retained |`custody-pre.json`; `identities.json`; `commands/CMD-G02.json` SHA-256 `b73cdcc4c23c4c98ae58379960a91a7a4de09f2a308f3e00526ddd6e478ebc98`| runner owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-G07` | `G06` | append-only reporting active | `PASS` | `S04-V43` pre-entry before first live action | `e2e/test-report.md`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | test owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-G08` | product/E2E correctness | correctness-before-performance approval | `PASS` | `V02`–`V35`, `V45`–`V46` direct pass before `B02` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | verification owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I01` | `G04`,`G05` | materialization key/coordinator | `PASS` | `V05`–`V12` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | LayerStack owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I02` | `I01` | native capability/writer backend | `PASS` | `V05`–`V10`,`V31` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | LayerStack/backend owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I03` | `I01`,`I02` | generation manifest/current/lease | `PASS` | `V13`–`V18` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | LayerStack owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I04` | `I01`–`I03` | durable operations/recovery/failpoints | `PASS` | `V19`–`V24` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | LayerStack owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I05` | `I01`–`I04` | candidate module integration | `PASS` | `CMD-P01`,`P02`,`P03` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | LayerStack owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I06` | `I03`–`I05` | private service APIs/models | `PASS` | `V03`,`V13`,`V25` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | LayerStack service owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I07` | `I01`–`I06` | route/resource observations | `PASS` | `V27`–`V30` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | observability owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I08` | `I06`,`I07` | strict private config/daemon wiring | `PASS` | `V03`,`V25`,`V32` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | config/daemon owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I09` | `I03`,`I06`,`I08` | strict session admission/rollback | `PASS` | `V15`–`V18`,`V22`–`V28` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | operation owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I10` | `I09` | exact workspace lease/persistence/lifecycle | `PASS` | `V15`–`V18`,`V23`,`V28` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | WorkspaceManager owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I11` | `I09`,`I10` | native mount and `/eos` masking | `PASS` | `V25`,`V26`,`V31` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | namespace/overlay owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I12` | `I09`–`I11` | command/file/PTY warm-route integration | `PASS` | `V25`–`V28` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | operation/execution owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I13` | `I01`–`I07` | product materialization tests | `PASS` | `CMD-P03`; `V05`–`V24`,`V29` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | product test owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I14` | `I08`–`I12` | strict workspace tests | `PASS` | `CMD-P04`; `V15`–`V30` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | product test owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I15` | `I01`–`I14` | inherited contract/regression tests | `PASS` | `V02`–`V04`,`V46` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | product test owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I16` | `I13`–`I15`,`I18` | typed Stage 04 E2E module | `PASS` | `V01`,`V05`–`V32`,`V45` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | E2E owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I17` | `I16`,`I20` | E2E evidence/accounting helpers | `PASS` | `V01`,`V27`,`V35`,`V45` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | E2E owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I18` | `G04` | deterministic materialization fixture | `PASS` | `V05`–`V10`,`V34` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | fixture owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I19` | `I16` | catalog declarations/export | `PASS` | `V01`,`V32` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | catalog owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I20` | specification | strict evidence schema | `PASS` | `V34`,`V35` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | schema owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I21` | `I17`,`I20`,`I24` | runner-owned campaign adapter | `PASS` | `V36`–`V42` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | benchmark owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I22` | `I21` | planning/runner/catalog dispatch | `PASS` | `V34`,`V36` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | benchmark owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I23` | `I21`,`I22` | frozen Stage 04 preset | `PASS` | `V34`,`V36` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | benchmark owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I24` | `I20` | golden artifact/threshold contract | `PASS` | `V34`,`V35` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | benchmark schema owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I25` | `I20`–`I24` | unit/planning/runner/verifier tests | `PASS` | `CMD-A01`; `V34`,`V35` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | benchmark test owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I26` | `G07` | append-only report entries | `PASS` | `V43` for every live command | `e2e/test-report.md`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | executing owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-I27` | all completion rows | benchmark note and Stage 05 handoff | `PASS` | `V44`,`V47` | `handoff_to_stage_05.md`; `benchmark_note.md`; `final-v1-authority.json` SHA-256 `22eac843a5f44b6aeb8d5054089d7d2d16928c69eb0c78f1d13761158cac0073` | documentation owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-E01`–`S04-E12` | `I16`–`I20` | complete typed E2E families | `PASS` | `V05`–`V32`,`V45` via `CMD-E03` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | E2E owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-L01`–`S04-L13` | `I03`,`I09`–`I11`,`I16` | complete `/eos` lifecycle proof | `PASS` | `V13`–`V18`,`V26`,`V45` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | storage/E2E owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-R01`–`S04-R08` | all runtime work | ownership/resource/quiescence proof | `PASS` | `V12`,`V17`–`V30`,`V36`,`V42`,`V45` | `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a` | run owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-D01` | product complete | dependency/portability audit | `PASS` | `V33`; `CMD-D01` plus retained comparator | `dependency/dependency-delta-final.json` SHA-256 `a4fd0ed027f72bad8ae717d6fbf320122688d9fdb600ae385432dc88cf2b993b`; `dependency/boundary-audit.json` SHA-256 `dd8ce7c5c44daa22bbac6924377d72b24b4dfa3df969a6086adf261384091baf` | dependency audit owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-A01` | `I20`,`I24` | complete strict artifact | `PASS` | `V34`,`V36`–`V42` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | artifact owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-A02` | `A01` | strict verifier/negative tests | `PASS` | `V35`; `CMD-A01` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | verifier owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-A03` | `G07`,`I26` | append-only reporting | `PASS` | `V43` | `e2e/test-report.md`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | run owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-B01` | `G08`,`A01`,`A02` | validated 180-second plan | `PASS` | `V34`,`V36`; `CMD-B01` then `CMD-B02` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | benchmark owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-B02` | `B01` | time/space/resource campaign evidence | `PASS` | `V36`–`V42` | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | benchmark owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-B03` | `B02` | honest performance disposition | `PASS` | each gate direct; insufficient stays insufficient | `stage04-materialization-evidence-v1.json` SHA-256 `9116f77b9f327b3d0e1aacf2d59b7286e21e00395c15347f178090d5cd625434`; `commands/TEST-PREFLIGHT-POOL-PRECAMPAIGN-D202.json` SHA-256 `d6944997b6d789f885b3a65a760eebff497d60e4ded8da1d1a82956c1b6689d1` | verification owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-H01` | all Stage 04 correctness | final v1 authority compatibility | `PASS` | `V03`,`V04`,`V46` | `final-v1-authority.json` SHA-256 `22eac843a5f44b6aeb8d5054089d7d2d16928c69eb0c78f1d13761158cac0073`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a`; `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9` | product/E2E owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-H02` | `H01`,`B03`,`D01` | final artifacts/digests/tracker closure | `PASS` | `V43`,`V44` and mapping audit | `final-v1-authority.json` SHA-256 `22eac843a5f44b6aeb8d5054089d7d2d16928c69eb0c78f1d13761158cac0073`; `commands/CMD-P05-FINAL-V1-RETRY-D209.json` SHA-256 `14c8a83f4b479560e485d3a29520b2240c0302cd157ece45ed5097f9460b411a`; `commands/CMD-E03-FINAL-D210.json` SHA-256 `05bae8e7b06c1a02559c65ed94a96c6400fe5ec2654b871d168ca1338a097de9` | verification owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-H03` | `H02` | outgoing Stage 04.5 and Stage 05 handoffs | `PASS` | `V47` and template §17 | `handoff_from_stage_04.md`; `handoff_to_stage_05.md`; `benchmark_note.md`; `final-v1-authority.json` SHA-256 `22eac843a5f44b6aeb8d5054089d7d2d16928c69eb0c78f1d13761158cac0073` | documentation owner | exact cleanup/custody PASS | 2026-07-26 |
| `S04-H04` | `H03` | docs links/diff validation | `PASS` | `CMD-H01`, link/mapping/scope checks | `commands/CMD-H01-FINAL-D214.json` SHA-256 `45b1110a1ccbfa7b75201e4efa64e9aba3e36d52d7f0b88416e5ef44e75aa7b8`; `docs-final-validation.json` SHA-256 `1da3cc7aa960073550947acfe020904b4bcf40d30d1988ac89c712cf13bb420c` | documentation owner | no runtime | 2026-07-26 |
| `S04-Q07` | Stage 07 | release qualification and retirement | `DEFERRED_STAGE_07` | only Stage 07 may change after its entry gates | `stage07-deferral-audit.json` SHA-256 `7f4173df64a8e37e427efcd26e2158707505af18a9eeac6c810d9e61b4fb0e6c` | Stage 07 owner | Stage 07-owned; no resource created | 2026-07-26 |
...
| --- | --- | --- | --- | --- |
| [x] Custody and inherited Stage 03 compatibility reconciled | `S04-G01`–`S04-G04`,`S04-I15` | `S04-V02`–`S04-V04`,`S04-V43` | `$S04_E2E_EVIDENCE/{custody-pre.json,identities.json,commands/CMD-G02.json,commands/CMD-P05.json}` with digests | no unowned mutation; exact test cleanup |
| [x] Exact reconstruction and capability failure | `S04-I01`–`S04-I05`,`S04-I13`,`S04-I18`,`S04-E01`,`S04-E02` | `S04-V05`–`S04-V10` | `$S04_E2E_EVIDENCE/{commands/CMD-P03.json,commands/CMD-E03.json,cases/E01-*,cases/E02-*}` | private build/session residue reconciled |
| [x] Typed catalog and honest platform/capability matrix | `S04-G06`,`S04-I16`,`S04-I17`,`S04-I19`,`S04-E12` | `S04-V01`,`S04-V31`,`S04-V32` | `$S04_E2E_EVIDENCE/{commands/CMD-E01.json,commands/CMD-E02.json,commands/CMD-E03.json,cases/E12-*}` | exact per-cell resources cleaned; unrun cells remain `NOT_RUN` |
| [x] Reuse and same-key single-flight | `S04-I01`,`S04-I03`,`S04-I04`,`S04-E03` | `S04-V11`,`S04-V12` | `$S04_E2E_EVIDENCE/{commands/CMD-P03.json,commands/CMD-E03.json,cases/E03-*}` | waiters/tasks/permits/residue zero/bounded |
| [x] Strict no-fallback routing | `S04-I06`,`S04-I08`–`S04-I12`,`S04-E04` | `S04-V03`,`S04-V25`,`S04-V26` | `$S04_E2E_EVIDENCE/{commands/CMD-P04.json,commands/CMD-E03.json,cases/E04-*}` and route snapshots | session/mount/lease teardown |
| [x] Warm zero-forbidden-work counters | `S04-I07`,`S04-I12`,`S04-E04` | `S04-V27` | `$S04_E2E_EVIDENCE/cases/E04-*/native-route-before-after.json` | counters/resources settled |
| [x] `CURRENT` atomicity and exact generation leases | `S04-I03`,`S04-I04`,`S04-I09`,`S04-L03`–`S04-L06` | `S04-V13`–`S04-V16`,`S04-V19`–`S04-V23` | `$S04_E2E_EVIDENCE/{cases/E05-*,cases/E06-*,cases/E07-*}` plus `commands/CMD-E03.json` | old/new exact leases released in order |
| [x] Concurrency, isolation, quotas, and backpressure | `S04-I01`,`S04-I07`,`S04-I09`–`S04-I14`,`S04-E03`,`S04-E07`,`S04-E09` | `S04-V12`,`S04-V17`,`S04-V28`,`S04-V29` | `$S04_E2E_EVIDENCE/{cases/E03-*,cases/E07-*,cases/E09-*}/resources.json` | every owned gauge/path returns to baseline |
| [x] All recovery boundaries | `S04-I04`,`S04-I09`,`S04-I10`,`S04-E05`,`S04-E06`,`S04-E08` | `S04-V19`–`S04-V24` | `$S04_E2E_EVIDENCE/{cases/E05-*,cases/E06-*,cases/E08-*}` with one boundary record per failpoint | exact recovery/reap ledger |
| [x] Complete `/eos` lifecycle and workload mask | `S04-G05`,`S04-I03`,`S04-I09`–`S04-I11`,`S04-E11`,`S04-L01`–`S04-L13` | `S04-V13`–`S04-V18`,`S04-V26`,`S04-V45` | `$S04_E2E_EVIDENCE/cases/E11-*/{tree.json,mountinfo.txt,space.json}` | `S04-L11`–`S04-L13`,`S04-R03`–`S04-R07` |
| [x] Inactive versus active MCTS allocation | `S04-E10` | `S04-V30` | `$S04_E2E_EVIDENCE/cases/E10-*/{refs.json,space.json,resources.json}` | active sessions retired; refs intentional |
| [x] 180-second time/space/resource campaign | `S04-G08`,`S04-I21`–`S04-I23`,`S04-B01`–`S04-B03`,`S04-A01`,`S04-A02`,`S04-R01`–`S04-R08` | `S04-V36`–`S04-V42` | `$S04_ARTIFACT_ROOT/stage04/{stage04-materialization-evidence-v1.json,verdict.json,sha256sums.json}` and `CMD-B02` result | `$S04_ARTIFACT_ROOT/stage04/cleanup/ledger.json` durable by 180s |
| [x] Dependency and portable-core boundary audit | `S04-D01` | `S04-V33` | `$S04_TEST/.e2e-state/tmp/$S04_RUN_ID/dependency-delta-{a,b}.json` plus `$S04_E2E_EVIDENCE/dependency/boundary-audit.json` and digests | no runtime resources |
| [x] Artifact/verifier negative tests | `S04-I20`,`S04-I24`,`S04-I25`,`S04-A01`,`S04-A02` | `S04-V34`,`S04-V35` | `$S04_E2E_EVIDENCE/{commands/CMD-A01.json,commands/CMD-B01.json,artifact-negative-cases.json}` and golden digest | test temp artifacts removed |
| [x] Append-only E2E reporting | `S04-G07`,`S04-I26`,`S04-A03` | `S04-V43` | exact pre/post entries in `e2e/test-report.md`, report SHA-256, and `$S04_E2E_EVIDENCE/report-entry-index.json` | each entry records exact cleanup |
| [x] Final v1 authority regression | `S04-G03`,`S04-I15`,`S04-H01` | `S04-V03`,`S04-V04`,`S04-V46` | `$S04_E2E_EVIDENCE/{commands/CMD-P05.json,commands/CMD-E03.json,final-v1-authority.json}` | no candidate/public leak |
| [x] Cleanup and quiescence | `S04-R01`–`S04-R08`,`S04-L09`–`S04-L13` | `S04-V12`,`S04-V17`–`S04-V30`,`S04-V36`,`S04-V42`,`S04-V45` | `$S04_E2E_EVIDENCE/quiescence-final.json` and `$S04_ARTIFACT_ROOT/stage04/{samples/resources.ndjson,samples/space.ndjson,cleanup/ledger.json}` | exact zero run-owned/unexplained result |
| [x] Outgoing Stage 04.5 and Stage 05 handoffs | `S04-I27`,`S04-H02`–`S04-H04` | `S04-V44`,`S04-V47` | `handoff_from_stage_04.md`, `handoff_to_stage_05.md`, `benchmark_note.md`, `CMD-H01-FINAL-D214.json` SHA-256 `45b1110a1ccbfa7b75201e4efa64e9aba3e36d52d7f0b88416e5ef44e75aa7b8` | cleanup digest and retained state named |
| [x] Stage 07 deferrals remain explicit | `S04-Q07`,`S04-H03`,`S04-H04` | `S04-V32`,`S04-V44`,`S04-V47` | both outgoing handoffs plus `stage07-deferral-audit.json` SHA-256 `7f4173df64a8e37e427efcd26e2158707505af18a9eeac6c810d9e61b4fb0e6c` | no Stage 07 resource created |

## 15. Closure disposition and standing stop conditions

No non-deferred Stage 04 blocker remains. Direct evidence is retained for product
and E2E correctness, the focused performance campaign, dependency/portable-core
boundaries, v1 authority compatibility, and exact ownership-relative cleanup.
The host still contains unrelated shared gateways/listeners, so this closure makes
an exact Stage 04 ownership-relative quiescence claim, never a global-zero claim.
The selected Linux/arm64 cell passed; the six unexecuted environment cells and all
generalized release claims remain explicitly deferred to Stage 07.
